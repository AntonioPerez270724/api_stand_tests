...
#Prueba 3. Creacion de un nuevo usuario o usuaria
#El parametro "firstName" contiene 1 caracter
def test_create_user_1_letter_in_first_name_get_success_response():
    negative_assert_symbol("A")
#Prueba 4. Creacion de un nuevo usuario o usuaria
#El parametro "firstName" contiene 1 caracter
def test_create_user_16_letter_in_first_name_get_success_response():
    negative_assert_symbol("Aaaaaaaaaaaaaaaa")
#Prueba 5. Creacion de un nuevo usuario o usuaria
#El parametro "firstName" contiene un espacio
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("A Aaa")
#Prueba 6. Creacion de un nuevo usuario o usuaria
#El parametro "firstName" contiene un caracter especial
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")
#Prueba 7. Creacion de un nuevo usuario o usuaria
#El parametro "firstName" contiene un numero en el primer nombre
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("Aaa1a")
# Prueba 8. Error
